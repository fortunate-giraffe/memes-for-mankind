(function() {
  ...
  function chromeDetect (events, socketDev) {
    ...
    function checkBrowser () {
      ...
      browserIsChrome = (!window.cordova && !window.chrome && !socketDev) ? false : true;
    ...
    function checkExtension () {
      ...
      browserHasExtension = (!window.cordova && !window.chrome.cast.extensionId && !socketDev) ? false : true;
